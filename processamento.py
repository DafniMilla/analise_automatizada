...
# GÊNERO GERAL
    ...
    sns.countplot(data=microdados, x="tp_sexo")
...
# MODALIDADE
    ...
    sns.countplot(data=microdados, x="tp_modalidade")
...
# IDADE
    ...
    sns.histplot(microdados["idade"], bins=25, kde=True)
...
# IDADE POR CURSO
    ...
    sns.boxplot(data=microdados, x="idade", y="nome_curso")
...
# TURNOS
    ...
    fig = plt.figure(figsize=(8,5))
    sns.countplot(data=microdados, x="turno")
...
# MUNICÍPIOS
    ...
    sns.barplot(data=topMun, x="Qtd", y="Municipio")
...
# NOTA POR UF
    ...
    fig = plt.figure(figsize=(10,5))
    sns.barplot(data=rankingUF, x="uf_campus", y="nu_notacorte")
...
# RANKING CURSOS
    ...
    fig = plt.figure(figsize=(12,6))
    sns.barplot(data=ranking, x="nu_notacorte", y="nome_curso")
...
<h1>Evolução das Notas ao Longo dos Períodos</h1>
